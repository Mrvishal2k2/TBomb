...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/mrvishal2k2/TBomb/archive/dev.zip"
        dir_name = "TBomb-dev"
    else:
        zip_url = "https://github.com/mrvishal2k2/TBomb/archive/master.zip"
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/mrvishal2k2/TBomb.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/mrvishal2k2/TBomb.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://raw.githubusercontent.com/mrvishal2k2/TBomb/master/.version"
    ).text.strip()
    if fver != __VERSION__:
...
def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/mrvishal2k2/TBomb/raw/dev/.notify"
        else:
            url = "https://github.com/mrvishal2k2/TBomb/raw/master/.notify"
...
def selectnode(mode="sms"):
    ...
    try:
        ...
        max_limit = {"sms": 1000000, "call": 10000000, "mail": 200}
        cc, target = "", ""
        if mode in ["sms", "call"]:
